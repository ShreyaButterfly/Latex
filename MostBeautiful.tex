...
\begin{frame}
	...
	\large $$i\sin(x) = 0+i.x.\dfrac{1}{1!} -i.x^3.\dfrac{1}{3!} + i.x^5.\dfrac{1}{5!} +\dots$$
...
\begin{frame}
	...
	\begin{center}
	$\cos(x) + i\sin(x) = 1+i.x.\dfrac{1}{1!}- x^2.\dfrac{1}{2!} -i.x^3.\dfrac{1}{3!} +x^4.\dfrac{1}{4!} + i.x^5.\dfrac{1}{5!} +\dots = e^{ix}$
	\end{center}
...
\begin{frame}
	...
	\begin{center}
	Now I will show you all a graphical representation of the most beautiful mathematical formula on GeoGebra. 
	\end{center}
\end{frame}
